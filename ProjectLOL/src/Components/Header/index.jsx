...
function Header() {
  return (
    <div className=" fixed top-0 left-0 right-0 z-50">
      <div className="w-full h-[80px] bg-black justify-between flex ">
      <div className="  content-center flex justify-start ">
        <div className="flex justify-center items-center">
          <svg
            className="ml-9 fill-white hover:fill-red-600 font-bold text-sm cursor-pointer"
            width="85"
            height="27"
        ...
        <div className="flex justify-center items-center ml-[22px] mr-[10px]">
          <a href="">
            <svg
        ...
        <div className="flex justify-center my-[7px] items-center ml-[10px]  hover:border-b-4 border-sky-500 ">
          <a href="">
            <p className="px-[16px] py-[8px]  text-white  hover:bg-[#808080] rounded-[6.4px] ">
              Trò Chơi
            </p>
          </a>
        </div>
        <div className="flex justify-center my-[7px] items-center hover:border-b-4 border-sky-500">
          <a href="">
            <p className="px-[16px] py-[8px]  text-white hover:bg-[#808080] rounded-[6.4px]">
              Tướng
            </p>
      ...
      <div className="content-center flex justify-start flex-row-reverse">
        <div
          className="flex justify-end items-center mr-[38px]"
          width="255"
          height="78 "
        >
          <a
            className="px-[16px] py-[8px] m-1.5 text-white hover:text-white bg-[#808080] rounded-[6.4px]"
            href=""
            width="87"
            height="16"
          >
          ...
          <a
            className="px-[16px] py-[8px] m-1.5 text-black hover:text-black bg-[#00b2cf] rounded-[6.4px]"
            href=""
            width="87"
            height="16"
          >
